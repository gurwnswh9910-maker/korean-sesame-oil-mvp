...
- Validation signal summary: `experiments/validation_signal_summary.md`, generated by `scripts/summarize_validation_signals.py`; current verdict `insufficient_external_evidence`
