...
- 2026-06-29T23:31+09:00 update: the aroma-loss / finishing-oil note was published at `https://note.com/dreamy_viola8978/n/n363650c8697f` with source `note_content_aromaloss`; public API shows `published`, comments enabled, 0 comments, 0 likes. This is not response evidence until a third-party comment/form/public answer/field row exists.
