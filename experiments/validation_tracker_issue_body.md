...
- note account-side posting: 2026-06-27T21:40+09:00 email activation completed; note draft `n77fa3f5a7fe9` is filled, saved, tagged, free, comments on, auto translation off, AI training compensation off; final `投稿する` is held until explicit user confirmation
