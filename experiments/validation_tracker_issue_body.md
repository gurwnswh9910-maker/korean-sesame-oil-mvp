...
- note account-side posting: 2026-06-27T20:56+09:00 Edge CDP check reached `https://editor.note.com/new` after login, but `POST /api/v1/text_notes` returned `422 email_activation`; note posting is held until the registered email verification is completed
