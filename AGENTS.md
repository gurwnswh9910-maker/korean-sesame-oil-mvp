...
- 6차 후보인 개봉 후 향 손실/큰 병 부담 note 원고는 `mvp/note_aromaloss_posting_packet.md`에 `ready_not_published`로 준비돼 있다. 2026-06-28T21:56+09:00 24h gate 결과 note 1~5 합산 views 36, comments 0, スキ 0, 실제 응답 0이라 `problem_language_or_cta_failure_consider_aromaloss_note`다. 바로 검증 성공이 아니며, 6차 note는 `/aroma-loss-goma`, `/quick-answer`, `/field-aroma` pre-publish routing 확인 후에만 게시 후보로 본다.
