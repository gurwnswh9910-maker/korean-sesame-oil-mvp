...
- note 댓글 실험은 `검증/note_댓글_관찰_접촉_패킷_20260628.md` 기준으로 하루 3개 이하, 링크 없이, 글 맥락에 맞는 질문만 남긴다. 2026-06-28T14:20+09:00 현재 인앱 브라우저는 note 로그아웃 상태이고 일반 Chrome에는 CDP 포트가 없어 댓글 후보는 `ready_not_posted`다.
