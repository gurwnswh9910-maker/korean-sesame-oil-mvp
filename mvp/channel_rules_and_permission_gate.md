...
작성일: 2026-06-27
최근 갱신: 2026-06-28T17:27:00+09:00
...
3. 반응이 0이면 `mvp/post_24h_action_packet_20260628.md`의 조회수 게이트를 적용한다. 합산 views < 30이면 유통 실패로 보고 6차 note 게시를 보류하고 `mvp/post_gate_external_channel_packet_20260628.md`에서 외부 채널 1개만 선택한다. 합산 views >= 30인데 응답 0이면 문제 언어/CTA 실패로 보고 6차 향 손실 note 후보를 검토한다. X/Threads는 사용자가 별도 허용할 때만 URL 없는 공개 질문 1회를 추가한다.
