...
| 순위 | 채널 | 이유 | 게시 문안 |
|---:|---|---|---|
| 1 | note `#韓国料理` / `#韓国旅行` 태그 | 2026-06-27T21:46+09:00 note 게시 완료. 2026-06-27T22:10+09:00 모바일 CTA를 `/answer-note`, `/share?src=note_kfood`, 댓글 템플릿으로 수정했다. 24시간 전체뷰/댓글/スキ/폼 응답을 확인한다. | `https://note.com/dreamy_viola8978/n/n77fa3f5a7fe9`, `?src=note_kfood` |
...
4. 긍정 댓글은 `/answer-note`로 이동시키거나, 폼이 귀찮으면 note 댓글 템플릿으로 바로 응답하게 한다. 더 긴 대화는 댓글/DM에서 최근 구매 행동을 묻는다.
