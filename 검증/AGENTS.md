...
- note/모바일 유입에서는 QR을 CTA로 쓰지 않는다. `https://korean-sesame-oil-mvp.vercel.app/answer-note`, note 댓글 템플릿, 탭 가능한 `/share` 링크를 우선한다.
...
- Vercel short answer link: `https://korean-sesame-oil-mvp.vercel.app/answer-note`
